                ...
                <table width={670} height={177} border = {0} align="center" >
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width={261}>
                                <label>
                                    <input name="hk1" type="number" min="0" max="10" size={90} onChange={this.myChangeHandler}/>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width={261}>
                                <label>
                                    <input name="hk2" type="number" min="0" max="10" size={20} onChange={this.myChangeHandler}/>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width={261}>
                                <label>
                                    <input name="MediumScore" type="text" readOnly value={this.state.MediumScore} size={20} onChange={this.myChangeHandler}/>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width={261}>
                                <label>
                                    <input name="ketqua" type="text" readOnly value={this.state.KQ} size={20} onChange={this.myChangeHandler}/>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width={261}>
                                <label>
                                    <input name="x" type="text" readOnly value={this.state.academicPower} size={20} onChange={this.myChangeHandler}/>
                                </label>
                            </td>
                        </tr>
                        <tr>
